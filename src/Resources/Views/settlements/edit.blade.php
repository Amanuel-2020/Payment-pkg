...
@section('content')
    <form action="{{route('settlements.update', $settlement->id)}}" method="post" class="padding-30 bg-white font-size-14">
        ...
        <x-input name="from[name]"
                 ...
                 placeholder="Sender's Card Holder Name" type="text" />
        ...
        <x-input name="to[name]"
                 ...
                 placeholder="Receiver's Card Holder Name" type="text" required/>
        ...
        <x-input name="amount" value="{{$settlement->amount}}" readonly placeholder="Amount in Toman" type="text" required/>
