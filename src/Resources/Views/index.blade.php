...
@section('content')
    <div class="row no-gutters">
        <div class="col-3 padding-20 border-radius-3 bg-white margin-left-10 margin-bottom-10">
            ...
            <p>{{number_format($last30DaysTotal)}} ETB</p>
        </div>
        <div class="col-3 padding-20 border-radius-3 bg-white margin-left-10 margin-bottom-10">
            <p>Net Income for the Last 30 Days</p>
            <p>{{number_format($last30DaysBenefit)}} ETB</p>
        </div>
        <div class="col-3 padding-20 border-radius-3 bg-white margin-left-10 margin-bottom-10">
            <p>Total Sales</p>
            <p>{{number_format($totalSell)}} ETB</p>
        </div>
        <div class="col-3 padding-20 border-radius-3 bg-white margin-bottom-10">
            <p>Total Net Income</p>
            <p>{{number_format($totalBenefit)}} ETB</p>
        </div>
    </div>
            ...
            <form action="">
                <div class="t-header-searchbox font-size-13">
                    ...
                    <div class="t-header-search-content">
                        ...
                        <input type="text" class="text" name="amount" value="{{request('amount')}}" placeholder="Amount in ETB">
