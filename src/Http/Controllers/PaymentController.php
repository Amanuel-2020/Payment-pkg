...
class PaymentController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        if (!$payment) {
            newFeedback("Transaction Failed", "The transaction you requested was not found!", "error");
            return redirect("/");
        }
        ...
        if (is_array($result)) {
            ...
            newFeedback("Operation Successful", "Payment was completed successfully.", "success");
